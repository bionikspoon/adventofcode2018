...
describe.each`
  ...
  ${'case-2.txt'} | ${1}   | ${'case-2-round-01.txt'} | ${true}
  ${'case-2.txt'} | ${2}   | ${'case-2-round-02.txt'} | ${true}
  ${'case-2.txt'} | ${23}  | ${'case-2-round-23.txt'} | ${true}
  ${'case-2.txt'} | ${24}  | ${'case-2-round-24.txt'} | ${true}
  ${'case-2.txt'} | ${25}  | ${'case-2-round-25.txt'} | ${true}
  ${'case-2.txt'} | ${26}  | ${'case-2-round-26.txt'} | ${true}
  ${'case-2.txt'} | ${27}  | ${'case-2-round-27.txt'} | ${true}
  ${'case-2.txt'} | ${28}  | ${'case-2-round-28.txt'} | ${true}
  ${'case-2.txt'} | ${47}  | ${'case-2-round-47.txt'} | ${true}
